...
user6 = User.create(first_name: "Anastassia", last_name: "Bobokalonova", username: "Anna", email: "anastassia@yahoo.com", password: "123456", image_url: 'efmecgbnbrcalfqellxx')
user4 = User.create(first_name: "Isak", last_name: "Mulligan", username: "TA", email: "Isakmcladenoff@gmail.com", password: "123456", image_url: 'isak')
user7 = User.create(first_name: "Jon", last_name: "Lofton", username: "Lofty", email: "jl@gmail.com", password: "123456", image_url: 'lofton')
...
user11 = User.create(first_name: "Janet", last_name: "Lee", username: "GhettoBlasta", email: "rapgawd@gmail.com", password: "waitreally", image_url: 'jlee')
...
Comment.create(project_id: project2.id, body: "Can you mentor me?", user_id: user4.id)
...
Comment.create(project_id: project3.id, body: "Is this really pop culture?", user_id: user4.id)
